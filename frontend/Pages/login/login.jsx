...
function Login() {
    ...
    <div className="w-[900px] h-[550px] flex bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="w-1/2 bg-white text-center text-[#333333] flex flex-col justify-center px-8">
        ...
        <form className="flex flex-col space-y-4">
          ...
          />
             ...
             <div className="relative">
              ...
              <button
                type="button"
                className="absolute inset-y-0 right-3 flex items-center text-gray-500 hover:text-[#00A693]"
        ...
        <button className="w-full mt-5 text-xl bg-[#00A693] text-white font-semibold py-3 rounded-md shadow-md hover:bg-[#008977] transition duration-300">
          Login
        </button>
