  ...
  return (
    <div>
      <div className='heading h-max w-full'>
        <h1 className='text-5xl font-bold mt-10 ml-20'>Why Trust Us?</h1>
        <div className='about w-full h-max-content mt-14'>
        <h2 className='ml-72 text-2xl font-bold'>Safe and Verified Rides</h2>
            ...
            <p className='mr-15 text-lg italic'> 
            ...
            {/* about 2 */}
            <h2 className='ml-20 text-2xl font-bold'>Affordable & Cost-Effective</h2>
            <div className=' flex w-full'>
            <p className='ml-20 text-lg italic'> 
            ...
            {/* about 3 */}
            <h2 className='ml-79 text-2xl font-bold'>Eco-Friendly Travel</h2>
            <div className=' flex w-full'>
            ...
            <p className='mr-15 ml-2 text-lg italic'> 
