...
const navigation = [
  { name: "Home", href: "/" },   // Change href to the route path
  { name: "Ride", href: "/ride" },
...
const Navbar = () => {
  return (
    <div>
    <Disclosure as="nav"  className="navbar bg-transparent backdrop-blur-md fixed w-full z-10 top-0 left-0">
            ...
            className={({ isActive }) =>
              classNames(
                isActive
                  ...
                  : "text-gray-100 hover:bg-blue-400 hover:bg-opacity-10 hover:text-white",
